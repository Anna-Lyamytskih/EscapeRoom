...
import { fetchReservationAction } from '../../store/bookinng-process/api-actions';
...
const BookingForm = ({ place }: BookingFormProps) => {
  ...
  const { register, handleSubmit, reset, formState: { errors, isValid } } = useForm<BookingForm>({
